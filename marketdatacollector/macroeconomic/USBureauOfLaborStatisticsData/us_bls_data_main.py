...
def get_downloader(registration_key, indictator):
    ...
    try:
        ...
        if indictator == 'cpi':
            return us_bls_data_downloader.USBLSCPIDownloader(registration_key)

        elif indictator == 'ppi':
            return us_bls_data_downloader.USBLSPPIDownloader(registration_key)
...
if __name__ == "__main__":
    ...
    config_input['item'] = items_list

    downloader.specify_data_indicator(config_input)
